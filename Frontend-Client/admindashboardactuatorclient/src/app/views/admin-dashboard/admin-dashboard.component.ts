...
import { AdminDashboardService } from './../../data/services/admin-dashboard.service';
import { SystemCpu } from './../../data/schema/system-cpu';
import { SystemHealth } from './../../data/schema/system-health';
import { Component, OnInit } from '@angular/core';
import { Chart, BarElement, BarController, CategoryScale, Filler, Legend, Title, Tooltip, LinearScale, PieController,ArcElement } from 'chart.js';
...
export class AdminDashboardComponent implements OnInit {
  ...
  constructor(private _dashboardService: AdminDashboardService) {
    Chart.register(BarElement, BarController, CategoryScale, Filler, Legend, Title, Tooltip,LinearScale,PieController,ArcElement );
   }
  ...
  private getTraces() {
    this._dashboardService.getHttpTraces().subscribe(
      (response: any) => {
  ...
  private getSystemHealth() {
    this._dashboardService.getSystemHealth().subscribe(
      (response: SystemHealth) => {
        ...
        console.log("systemHealth" +response);
  ...
  private getProcessUpTime(isUpdateTime: boolean) {
    this._dashboardService.getProcessUptime().subscribe(
      (response: any) => {
